...
static char* not_found_response_template =
	...
	"<div class='text-center alert alert-danger'>"        
		"<h1>404 Not Found Error</h1>\n"
        	"<p>Não encontrada a URL %s neste servidor.</p>\n"
		"<div style='text-align: left; width: 29%; margin: auto;'>"
			"<p>Você pode utilizar os seguintes comandos:</p>"
			"<ul>"
				"<li>localhost:4000/cal</li>\n"
				"<li>localhost>4000/cal?ano=XXXX&mes=XX</li>\n"
				"<li>localhost:4000/time</li>\n"
				"<li>localhost:4000/diskfree</li>\n"
				"<li>localhost:4000/issue</li>\n"
			"</ul>\n"
		"</div>\n"	
		"<p>Utilize os parâmetros ano=XXXX&mes=XX</p>\n"
	"<div>"
        " </body>\n"
        "</html>\n";
...
static void handle_get(int connection_fd, const char* page) {
    ...
    if (*page == '/' && strchr(page + 1, '/') == NULL) {//pega o que está depois da '/'
        ...
        if (strchr(auxpage, '?') != NULL){ // SE ACHOU PARÂMETRO
            ...
            // PÁGINA NÃO POSSUI PARÂMETROS, SEGUE O BAILE
            snprintf(module_file_name, sizeof (module_file_name),
                    "%s.so", page + 1);
