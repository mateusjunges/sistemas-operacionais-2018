//
//  Exemplo de simulação simples de escalonamento
//
//  compilar:   gcc simulador.c -o simul -D DEBUG
//  executar:   ./simul
...
{
    switch( _cpu.ci ) {
      case 0 : printf( "1: Este é o processo 1\n" );
               _cpu.ci++;
               break;
      case 1 : _cpu.ci = 0;
               break;
...
{
    switch( _cpu.ci ) {
       case 0 : printf( "2: Este é o processo 2\n" );
               _cpu.ci++;
                break;
...
{
    switch( _cpu.ci ) {
       case 0 : printf( "3: Este é o processo 3\n" );
               _cpu.ci++;
                break;
       case 1 : _cpu.ci = 0;
                break;
...
{
    switch( _cpu.ci ) {
       case 0 : printf( "4: Este é o processo 4\n" );
               _cpu.ci++;
                break;
       case 1 : _cpu.ci = 0;
                break;
